...
% \begin{table}
%     \centering
%     \caption{Parameter values used in the preliminary analysis. In the preliminary analysis, we used a Ricker model to simulate community dynamics.}
%     \begin{tabular}{cll}
%         Symbol & Interpretation & Value\\
%         \hline
%         $r_i$            & Intrinsic population growth  & 1.00 or $\mbox{Unif(0.90, 1.10)}$\\
%         $\alpha_{i}$     & Intraspecific competition    & 0.01, 0.02\\
%         $\beta_{ij}$     & Interspecific competition    & $\mbox{Normal}(\mu_{\beta}, \sigma_{\beta}^2)$\\
%         $\mu_{\beta}$    & Average interspecific competition & $\alpha_i \times \{0.00, 0.25, ..., 1.50\}$\\
%         $\sigma_{\beta}$ & SD interspecific competition & $\mu_{\beta} \times \{0.00,  0.25\}$\\
%         $S$              & Number of species in a community & $5, 15$\\
%         $L_t$            & Length of time series            & $10, 30$\\
%         \hline
%     \end{tabular}
%     \label{tab:param0}
% \end{table}
